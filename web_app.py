...
<div class="wrap">
    ...
    <main class="grid">
        ...
        <!-- Adversarial stress test: Shariah/Gharar/Maysir/Riba refusals on demand.
             The live symbol universe is pre-screened, so those four gates rarely
             have a real trade to reject; this harness proves they refuse when tested
             directly, against the same functions in agent/gates/, not a simulation. -->
        <div class="card span-12" id="stressCard">
            <div class="card-title"><svg><use href="#i-shield"/></svg>Adversarial Gate Stress Test <span class="chip neutral" style="margin-left:8px">Offline &middot; deterministic &middot; not live trades</span></div>
            <div class="kpi-sub" style="margin:-4px 0 10px">
                20 scenarios run directly against the real gate functions in <code>agent/gates/</code> &mdash; no mocks, no network, no clock; byte-identical every run.
                The production symbol universe is already Shariah-screened, so a live Shariah/Gharar/Maysir/Riba refusal is rare by design &mdash; this is where each gate is shown refusing on demand, including the exact scenario a judge would ask for first: a profitable trade on an unlisted symbol (row 1).
            </div>
            <div class="table-scroll" style="max-height:360px">
            <table style="width:100%;border-collapse:collapse;font-size:12px">
              <thead><tr style="text-align:left;color:var(--muted);text-transform:uppercase;font-size:10px;letter-spacing:.05em">
                <th style="padding:6px 8px">#</th><th style="padding:6px 8px">Gate</th><th style="padding:6px 8px">Scenario</th><th style="padding:6px 8px">Situation</th><th style="padding:6px 8px">Verdict</th><th style="padding:6px 8px">Reason</th>
              </tr></thead>
              <tbody id="stressBody">
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">1</td><td style="padding:6px 8px"><span class="chip fail">SHARIAH</span></td><td style="padding:6px 8px">Profitable but unlisted</td><td style="padding:6px 8px;color:var(--muted)">TSLA put paying $12.00/share &mdash; richest premium on the board</td><td style="padding:6px 8px"><span class="chip fail">FAIL</span></td><td style="padding:6px 8px;color:var(--muted)"><code>not_on_curated_list</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">2</td><td style="padding:6px 8px"><span class="chip warn">RISK</span></td><td style="padding:6px 8px">Position too large</td><td style="padding:6px 8px;color:var(--muted)">MSFT 490 put &mdash; $49,000 collateral = 49% of equity</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>position_size_cap</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">3</td><td style="padding:6px 8px"><span class="chip info">STRUCTURE</span></td><td style="padding:6px 8px">Book already 2&times; levered</td><td style="padding:6px 8px;color:var(--muted)">8th cash-secured put with $201,500 already committed on $100,273 cash</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>insufficient_cash_collateral</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">4</td><td style="padding:6px 8px"><span class="chip pass" style="color:var(--danger);background:var(--danger-dim);border-color:rgba(239,68,68,.35)">RIBA</span></td><td style="padding:6px 8px">Margin-financed account</td><td style="padding:6px 8px;color:var(--muted)">Account carrying $150,000 of obligations against $100,000 cash</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>positions_financed_on_margin_not_cash</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">5</td><td style="padding:6px 8px"><span class="chip pass" style="color:var(--danger);background:var(--danger-dim);border-color:rgba(239,68,68,.35)">RIBA</span></td><td style="padding:6px 8px">Overdrawn account</td><td style="padding:6px 8px;color:var(--muted)">Account overdrawn by $5,000 &mdash; a broker loan</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>negative_cash_balance_is_an_interest_bearing_loan</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">6</td><td style="padding:6px 8px"><span class="chip pass" style="color:var(--danger);background:var(--danger-dim);border-color:rgba(239,68,68,.35)">RIBA</span></td><td style="padding:6px 8px">Short equity held</td><td style="padding:6px 8px;color:var(--muted)">100 shares of AAPL sold short (borrowed stock)</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>short_equity_position_requires_borrowing</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">7</td><td style="padding:6px 8px"><span class="chip pass" style="color:var(--danger);background:var(--danger-dim);border-color:rgba(239,68,68,.35)">RIBA</span></td><td style="padding:6px 8px">Interest-bearing holding</td><td style="padding:6px 8px;color:var(--muted)">500 shares of TLT (long-duration Treasury ETF)</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>interest_bearing_instrument_held</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">8</td><td style="padding:6px 8px"><span class="chip neutral">RANKER</span></td><td style="padding:6px 8px">Market crash &minus;20%</td><td style="padding:6px 8px;color:var(--muted)">Underlying gaps &minus;20% overnight; strikes now 19&ndash;24% ITM</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)">0 of 3 contracts eligible &mdash; outside the 2&ndash;7% OTM band</td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">9</td><td style="padding:6px 8px"><span class="chip fail">GHARAR</span></td><td style="padding:6px 8px">Illiquid contract</td><td style="padding:6px 8px;color:var(--muted)">Bid $1.00 / ask $3.00 &mdash; 100% spread on a thin contract</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>spread_too_wide_price_ambiguous</code> (cap 15% of mid)</td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">10</td><td style="padding:6px 8px"><span class="chip warn">RISK</span></td><td style="padding:6px 8px">Volatility spike</td><td style="padding:6px 8px;color:var(--muted)">3% OTM put bids $9.00; agent sized to 5 contracts</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>position_size_cap</code> &mdash; 48.5% of equity</td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">11</td><td style="padding:6px 8px"><span class="chip warn">RISK</span></td><td style="padding:6px 8px">Daily loss breach</td><td style="padding:6px 8px;color:var(--muted)">Account already &minus;4% on the day; a new trade is proposed</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>daily_loss_cap</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">12</td><td style="padding:6px 8px"><span class="chip fail">GHARAR</span></td><td style="padding:6px 8px">One-sided quote</td><td style="padding:6px 8px;color:var(--muted)">Contract quoted with no ask &mdash; a one-sided market</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>no_live_ask_price_is_one_sided</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">13</td><td style="padding:6px 8px"><span class="chip fail">GHARAR</span></td><td style="padding:6px 8px">Unpriceable volatility</td><td style="padding:6px 8px;color:var(--muted)">Implied volatility 350% &mdash; the market cannot price it</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>implied_volatility_beyond_assessable_range</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">14</td><td style="padding:6px 8px"><span class="chip fail">GHARAR</span></td><td style="padding:6px 8px">Cannot deliver</td><td style="padding:6px 8px;color:var(--muted)">$30,750 delivery obligation against $1,000 of cash</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>delivery_capacity_not_assured</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">15</td><td style="padding:6px 8px"><span class="chip info" style="color:#A855F7;background:rgba(168,85,247,.12);border-color:rgba(168,85,247,.35)">MAYSIR</span></td><td style="padding:6px 8px">Naked put</td><td style="padding:6px 8px;color:var(--muted)">Uncollateralised short put &mdash; no capacity to take delivery</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>position_is_naked_not_a_funded_commitment</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">16</td><td style="padding:6px 8px"><span class="chip info" style="color:#A855F7;background:rgba(168,85,247,.12);border-color:rgba(168,85,247,.35)">MAYSIR</span></td><td style="padding:6px 8px">Nominally secured</td><td style="padding:6px 8px;color:var(--muted)">Cash 'covers' it, but $94,500 is already committed</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>position_is_naked_not_a_funded_commitment</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">17</td><td style="padding:6px 8px"><span class="chip info" style="color:#A855F7;background:rgba(168,85,247,.12);border-color:rgba(168,85,247,.35)">MAYSIR</span></td><td style="padding:6px 8px">Strike above market</td><td style="padding:6px 8px;color:var(--muted)">Strike $320 against $316 spot &mdash; assignment is near-certain</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>strike_at_or_above_market_not_an_acquisition_discount</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">18</td><td style="padding:6px 8px"><span class="chip info" style="color:#A855F7;background:rgba(168,85,247,.12);border-color:rgba(168,85,247,.35)">MAYSIR</span></td><td style="padding:6px 8px">Zero-day expiry</td><td style="padding:6px 8px;color:var(--muted)">Same-session expiry &mdash; a bet on today's close</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>expiry_too_short_to_be_a_commitment</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">19</td><td style="padding:6px 8px"><span class="chip info" style="color:#A855F7;background:rgba(168,85,247,.12);border-color:rgba(168,85,247,.35)">MAYSIR</span></td><td style="padding:6px 8px">Unscreened underlying</td><td style="padding:6px 8px;color:var(--muted)">Put on a business that failed the activity screen</td><td style="padding:6px 8px"><span class="chip fail">REJECT</span></td><td style="padding:6px 8px;color:var(--muted)"><code>underlying_not_a_permissible_asset_to_acquire</code></td></tr>
                <tr style="border-top:1px solid var(--border)"><td style="padding:6px 8px">20</td><td style="padding:6px 8px"><span class="chip neutral">ALL SIX</span></td><td style="padding:6px 8px">Normal conditions</td><td style="padding:6px 8px;color:var(--muted)">AAPL 3% OTM put, $1.20 bid, 2 DTE, $9,700 collateral on $100k</td><td style="padding:6px 8px"><span class="chip pass">PASS</span></td><td style="padding:6px 8px;color:var(--muted)">all six gates PASS</td></tr>
              </tbody>
            </table>
            </div>
            <div class="kpi-sub" style="margin-top:10px"><strong style="color:var(--text)">19 refused, 1 allowed.</strong> Generated by <code>scripts/gate_stress.py</code>, calling the real gate functions &mdash; nothing here is mocked, so this table cannot drift from the code it describes. Full report: <code>docs/backtest/gate-stress-report.md</code>.</div>
        </div>
